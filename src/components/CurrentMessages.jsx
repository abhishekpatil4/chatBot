    ...
    return <Box sx={{ marginBottom: "4rem", overflow: 'scroll' }}>
        {
            messages.length > 0 ?
                messages.map((msg, idx) =>
                    <Message key={idx} time={msg.time} id={msg.id} type={msg.type} message={msg.message} rating={msg.rating} feedback={msg.feedback} showThumbs={idx===messages.length-1 && true}/>
                )
                :
